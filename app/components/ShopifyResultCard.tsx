        ...
        <Card variant="elevated" padding="lg" className="relative overflow-hidden">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-sm text-[#424242] font-mono font-medium">{result.url}</span>
              {result.shop_domain && (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-[#424242]">Detection Confidence</span>
                <span className="text-sm font-bold text-[#008060]">{confidenceDisplay}</span>
              </div>
              ...
              >
                {[
                  ...
                  >
                    ...
                    <span className="text-sm font-semibold text-[#1A1A1A]">{stat.value}</span>
                  </motion.div>
                ))}
              </motion.div>
            )}
